        ...
        <div id="container">
            ...
            <div class="logregpart">
                <div id="register">
                  ...
                  <br>
                   <h3 style="display:inline-block;">Description:</h3><h4  style="display:inline-block;margin-left:10px;">' . $row['description'] . '</h4>';
                        }
                    }
                    echo
                     '  <button style="
                        ...
                        margin-right: 10px;
              ">
                       <a href="addFav.php?user1=' . $user . ':' . $filmName . '"> Add to Favourites</a>
                        </button>
                </div>
